 ...
 */
final class Version20230503102427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id INT NOT NULL, recepe_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, quantity VARCHAR(55) DEFAULT NULL, unit VARCHAR(55) DEFAULT NULL, PRIMARY KEY(id))');
